...
def process_query(query):
    ...
    if 'exit' in query or 'stop' in query:
        ...
        response = get_answer_from_wikipedia(query)
        ...
        response = open_news()
    elif re.search(r'\b(who|what|when|where|how|why|name)\b', query):
        response = get_answer_from_wikipedia(query)
...
def get_answer_from_wikipedia(question):
    try:
        ...
        return "There were multiple results for your query, please be more specific."
